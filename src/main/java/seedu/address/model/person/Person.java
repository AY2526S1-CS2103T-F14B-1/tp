...
public class Person {
     ...
     */
    public Person(Name name, Phone phone, Email email, Category category, Set<Tag> tags) {
        requireAllNonNull(name, phone, email, category, tags);
        this.name = name;
        this.phone = phone;
        this.email = email;
    ...
    public int hashCode() {
        ...
        return Objects.hash(name, phone, email, category, tags);
    }
